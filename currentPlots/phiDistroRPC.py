...
def main():
  ...
  listaRatesAfterTS2CH =  rates_endcap_list("RSafter3CH/outputs/lumisection_testAfterTS2Endcap.csv")
  listaRatesBeforeTS2CH = rates_endcap_list("RSbefore3CH/outputs/lumisection_testBeforeTS2Endcap.csv")
