...
def plot_results(List, layer):
  ...
  l.SetTextSize(0.022)
  l.SetNColumns(1)
  l.AddEntry(List, "{} of the linear fits to fill(7252)/fill(7080) data".format(layer), "p")
...
def main():
  ...
  filenames, slopeRatio, offsetRatio = currentVsLumiPlots.main()
  ...
  plot_results(slopeTG, "slopes")
  plot_results(offsetTG, "offset")
  return
