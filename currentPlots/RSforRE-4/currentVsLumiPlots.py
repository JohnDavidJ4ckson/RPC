...
def plot_ts2_comparison(sector):
  ...
  listaRatesAfterTS2CH =  rates_endcap_list("outputs/lumisection_afterTS2{}.csv".format(sector))  # [0] - corresponds to Y
  listaRatesBeforeTS2CH = rates_endcap_list("outputs/lumisection_beforeTS2{}.csv".format(sector)) # [1] - corresponds to X
  ...
  #print "THIS is AFTER"
  tgraphsDictionaryAfterTS2  = generate_tgraphs(filteredListaAfterTS2CH,'RE-4 after TS2')
  #print "THIS is BEFORE"
  tgraphsDictionaryBeforeTS2 = generate_tgraphs(filteredListaBeforeTS2CH,'RE-4 before TS2')
  #print "Creating plots"
  tgraphList = [ tgraphsDictionaryBeforeTS2, tgraphsDictionaryAfterTS2 ]
  slopeRatio, offsetRatio = plot_results(tgraphList, "RE+4_CH{}_TS2".format(sector[2:]))
  #print "DONE"
  return slopeRatio, offsetRatio
...
def main():
  ...
  offsetRatio = []
  for f in fileNames:
    ratio1, ratio2 = plot_ts2_comparison(f)
  ...
  return fileNames, slopeRatio, offsetRatio
