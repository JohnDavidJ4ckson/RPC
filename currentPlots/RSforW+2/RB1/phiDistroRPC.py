...
def plot_results(List, layer):
  ...
  fit1 = List[0].Fit("fun1","R") # "FQ")
  fit2 = List[1].Fit("fun2","R") # "FQ")
...
def main():
  ...
  listaRatesAfterTS2CH =  rates_endcap_list("S07/outputs/lumisection_testAfterTS2.csv")
  listaRatesBeforeTS2CH = rates_endcap_list("S07/outputs/lumisection_testBeforeTS2.csv")
  ...
  plot_results(tgraphList, "W+2_RB1_S07_TS2")
  print "DONE"
  return
