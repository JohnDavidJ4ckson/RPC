...
def main():
  ...
  evalRates( regr,     50000, "RE")
  evalRates( rbgr,     50000, "RB")
  evalRates( wgr,      50000, "W")
  evalRates( rb1ingr,  50000, "RB1in")
  evalRates( rb1outgr, 50000, "RB1out")
  evalRates( rb2ingr,  50000, "RB2in")
  evalRates( rb2outgr, 50000, "RB2out")
  evalRates( rb3,      50000, "RB3")
  evalRates( rb4,      50000, "RB4")
