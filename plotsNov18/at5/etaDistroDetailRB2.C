...
//=========  (Tue Jan 22 22:07:56 2019) by ROOT version 6.12/04
   TCanvas *c1 = new TCanvas("c1", "Canvas",50,45,800,775);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->SetHighLightColor(2);
   c1->Range(-2.180107,-0.0866887,1.857128,3.197023);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogy();
   ...
   Graph_Graph27->SetMinimum(2.2635);
   Graph_Graph27->SetMaximum(121.6815);
   ...
   Graph_Graph28->SetMinimum(3.903);
   Graph_Graph28->SetMaximum(15.267);
   ...
   Graph_Graph29->SetMinimum(3.719);
   Graph_Graph29->SetMaximum(103.031);
   ...
   Graph_Graph30->SetMinimum(2.069);
   Graph_Graph30->SetMaximum(13.721);
   ...
   Graph_Graph31->SetMinimum(3.0215);
   Graph_Graph31->SetMaximum(14.8235);
   ...
   Graph_Graph32->SetMinimum(2.055);
   Graph_Graph32->SetMaximum(12.195);
