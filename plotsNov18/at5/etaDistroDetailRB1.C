...
//=========  (Tue Jan 22 22:07:55 2019) by ROOT version 6.12/04
   TCanvas *c1 = new TCanvas("c1", "Canvas",50,45,800,775);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c1->SetHighLightColor(2);
   c1->Range(-2.194995,0.2335224,1.851362,3.176584);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetLogy();
   ...
   Graph_Graph_Graph121->SetMinimum(0.873);
   Graph_Graph_Graph121->SetMaximum(49.797);
   ...
   Graph_Graph_Graph222->SetMinimum(19.501);
   Graph_Graph_Graph222->SetMaximum(56.569);
   ...
   Graph_Graph_Graph323->SetMinimum(1.6085);
   Graph_Graph_Graph323->SetMaximum(48.1265);
   ...
   Graph_Graph_Graph424->SetMinimum(3.131);
   Graph_Graph_Graph424->SetMaximum(74.639);
   ...
   Graph_Graph_Graph625->SetMinimum(16.8);
   Graph_Graph_Graph625->SetMaximum(43.44);
   ...
   Graph_Graph_Graph826->SetMinimum(5.766);
   Graph_Graph_Graph826->SetMaximum(47.454);
